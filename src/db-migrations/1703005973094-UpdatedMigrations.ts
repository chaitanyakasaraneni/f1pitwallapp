...
export class UpdatedMigrations1703005973094 implements MigrationInterface {
    name = 'UpdatedMigrations1703005973094'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "results" ADD CONSTRAINT "UQ_6ce829d081a1d8d857c56dc5447" UNIQUE ("drivers_short_id")`);
        await queryRunner.query(`ALTER TABLE "results" ADD CONSTRAINT "UQ_a14b01c3958a52cede584cb7285" UNIQUE ("constructors_short_id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "results" DROP CONSTRAINT "FK_6ce829d081a1d8d857c56dc5447"`);
        await queryRunner.query(`ALTER TABLE "results" DROP CONSTRAINT "UQ_a14b01c3958a52cede584cb7285"`);
        await queryRunner.query(`ALTER TABLE "results" DROP CONSTRAINT "UQ_6ce829d081a1d8d857c56dc5447"`);
        await queryRunner.query(`ALTER TABLE "results" ADD CONSTRAINT "FK_a14b01c3958a52cede584cb7285" FOREIGN KEY ("constructors_short_id") REFERENCES "constructors"("constructors_short_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "results" ADD CONSTRAINT "FK_6ce829d081a1d8d857c56dc5447" FOREIGN KEY ("drivers_short_id") REFERENCES "drivers"("drivers_short_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
