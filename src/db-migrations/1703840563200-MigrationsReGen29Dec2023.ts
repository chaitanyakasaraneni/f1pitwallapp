...
export class MigrationsReGen29Dec20231703840563200 implements MigrationInterface {
    name = 'MigrationsReGen29Dec20231703840563200'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "races" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "race_short_id" character varying(10) NOT NULL, "race_name" character varying(100) NOT NULL, "year" integer NOT NULL, "race_number" integer NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "circuit_short_id" character varying(36), CONSTRAINT "UQ_6d6f788b44a0fe808c3545406a1" UNIQUE ("race_short_id"), CONSTRAINT "UQ_6ef487536db8af4737b630b301c" UNIQUE ("race_name"), CONSTRAINT "PK_ba7d19b382156bc33244426c597" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "results" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "date" TIMESTAMP WITH TIME ZONE NOT NULL, "race_short_id" character varying(10), "constructors_short_id" character varying(36), CONSTRAINT "REL_2d91e4373c15853a461d547fed" UNIQUE ("race_short_id"), CONSTRAINT "PK_e8f2a9191c61c15b627c117a678" PRIMARY KEY ("id"))`);
